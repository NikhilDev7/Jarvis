...
reg8 = re.compile(regxp1,re.IGNORECASE)
reg9 = re.compile(regxp2,re.IGNORECASE)


def Findall(text):

    f1 = []
    f1.extend(reg1.findall(text))
    f1.extend(reg2.findall(text))
    f1.extend(reg3.findall(text))
    f1.extend(reg4.findall(text))
    f1.extend(reg5.findall(text))
    f1.extend(reg6.findall(text))
    f1.extend(reg7.findall(text))
    f1.extend(reg8.finditer(text))
    f1.extend(reg9.finditer(text))
    print(f1)
